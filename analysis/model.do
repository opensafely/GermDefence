...
graph export "$gd/output/rti_plot.emf", as(emf)
...
graph export "$gd/output/arti_plot.emf", as(emf)
...
graph export "$gd/output/gastro_plot.emf", as(emf)
...
graph export "$gd/output/coviddiag_plot.emf", as(emf)
...
graph export "$gd/output/covidsympsens_plot.emf", as(emf)
...
graph export "$gd/output/covidsympspec_plot.emf", as(emf)
...
graph export "$gd/output/antibio_plot.emf", as(emf)
...
graph export "$gd/output/adm_plot.emf", as(emf)
